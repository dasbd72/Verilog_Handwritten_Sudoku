...
HD_PWD='C:/Users/yuxun/Desktop/LDL_FinalProject_Sudoku/Sudoku_vivado/Sudoku_vivado.runs/Num1_Mem_Gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Num1_Mem_Gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Num1_Mem_Gen.tcl

...
HD_PWD='C:/Users/yuxun/Desktop/LDL_FinalProject_Sudoku/Sudoku_vivado/Sudoku_vivado.runs/Menu_Mem_Gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Menu_Mem_Gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Menu_Mem_Gen.tcl

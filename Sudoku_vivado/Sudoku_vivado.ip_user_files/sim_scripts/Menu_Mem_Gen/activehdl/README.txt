...
#
# Generated by export_simulation on Tue Jan 11 13:55:59 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Menu_Mem_Gen.sh' script.

./Menu_Mem_Gen.sh -reset_run
...
./Menu_Mem_Gen.sh -noclean_files

For more information on the script, please type './Menu_Mem_Gen.sh -help'.

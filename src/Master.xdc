...
set_property IOSTANDARD LVCMOS33 [get_ports stage]
...
# set_property PACKAGE_PIN V13 [get_ports {col[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {col[0]}]
# set_property PACKAGE_PIN V3 [get_ports {col[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {col[1]}]
# set_property PACKAGE_PIN W3 [get_ports {col[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {col[2]}]
# set_property PACKAGE_PIN U3 [get_ports {col[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {col[3]}]
# set_property PACKAGE_PIN P3 [get_ports {row[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {row[0]}]
# set_property PACKAGE_PIN N3 [get_ports {row[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {row[1]}]
# set_property PACKAGE_PIN P1 [get_ports {row[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {row[2]}]
# set_property PACKAGE_PIN L1 [get_ports {row[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {row[3]}]

...
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports receive_connect]
set_property IOSTANDARD LVCMOS33 [get_ports receive_connect]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports receive_start]
set_property IOSTANDARD LVCMOS33 [get_ports receive_start]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports receive_game_finish]
set_property IOSTANDARD LVCMOS33 [get_ports receive_game_finish]
##Sch name = JC10
